 ...
 * @author TheCelavi
 */
class dmFlashPlayerMetadataBehaviorView extends dmBehaviorBaseView {
    ...
    public function filterBehaviorVars(array $vars = array()) {
        ...
        if (isset($vars['url']) && $vars['url'] != '') $vars['url'] = $this->getService('flash_player')->url($vars['url'])->getUrl();
    ...
    public function getJavascripts() {
        return array(
            ...
            'dmMultimediaPlugin.flashPlayerBehaviorLaunch'
        );
    }
}
