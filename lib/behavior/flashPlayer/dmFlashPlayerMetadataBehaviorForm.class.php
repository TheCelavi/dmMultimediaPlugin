 ...
 * @author TheCelavi
 */
class dmFlashPlayerMetadataBehaviorForm extends dmBehaviorBaseForm {
    public function configure() {
        ...
        $this->getWidgetSchema()->setHelps(array(
            'url' => 'Supported format is .swf. If you do not enter, behavior will try to find out the link from the URL, if there is one near'
