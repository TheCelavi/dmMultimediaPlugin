 ...
 * @author TheCelavi
 */
class dmVideoPlayerMetadataBehaviorForm extends dmBehaviorBaseForm {
    public function configure() {
        ...
        $this->getWidgetSchema()->setHelps(array(
            'url' => 'Supported formats are .flv and .fl4. If you do not enter, behavior will try to find out the link from the URL, if there is one near',
