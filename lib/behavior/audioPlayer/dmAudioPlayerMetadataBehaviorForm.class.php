 ...
 * @author TheCelavi
 */
class dmAudioPlayerMetadataBehaviorForm extends dmBehaviorBaseForm {
    public function configure() {
        ...
        $this->getWidgetSchema()->setHelps(array(
            'url' => 'Supported formats are MP3 and AAC. If you enter none, behavior will try to find out the link from the URL, if there is one near',
        ));
